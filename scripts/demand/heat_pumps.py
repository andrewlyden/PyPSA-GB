...
def _calculate_fes_fraction(fes_path: str,
    ...
    if fes_year is None:
        logger.warning("FES year unavailable; cannot calculate heat pump fraction against ED1 consumer demand")
        return None
    ...
    try:
        ...
        logger.warning(f"Failed to read ED1 consumer demand for heat pump fraction: {exc}")
        return None
    ...
    logger.info(
        f"FES heat pump component total {comp_val:.1f} GWh / ED1 consumer demand {total_val:.1f} GWh"
    )
